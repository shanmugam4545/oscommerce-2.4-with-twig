...
<?php
        ...
        while ($pi = osc_db_fetch_array($pi_query)) {
          ...
          $pi_entry .= '" target="_blank" data-fancybox-gallery="fancybox">' . osc_image(DIR_WS_IMAGES . $pi['image'], '', '', '', ($pi_counter ==1) ? '' : '') . '</a>';
...
?>
    ...
    <div id="piGal" style="float: right;">
      <?php echo '<a href="' . HTTP_SERVER . DIR_WS_HTTP_CATALOG . DIR_WS_IMAGES . $product_info['products_image'] . '" target="_blank" data-fancybox-gallery="fancybox">' . osc_image(DIR_WS_IMAGES . $product_info['products_image'], $product_info['products_name'], null, null, 'hspace="5" vspace="5" itemprop="image"') . '</a>'; ?>
    </div>
...
<script>
$("#piGal a[data-fancybox-gallery='fancybox']").fancybox({
  cyclic: true
});
</script>
