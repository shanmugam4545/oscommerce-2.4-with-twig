...
*/
  ...
  class sb_digg {
    ...
    function getOutput() {
      return '<a href="http://digg.com/submit?url=' . urlencode(osc_href_link('products', 'id=' . $_GET['id'], 'NONSSL', false)) . '" target="_blank"><img src="' . DIR_WS_IMAGES . 'social_bookmarks/' . $this->icon . '" title="' . osc_output_string_protected($this->public_title) . '" alt="' . osc_output_string_protected($this->public_title) . '"/></a>';
    }
