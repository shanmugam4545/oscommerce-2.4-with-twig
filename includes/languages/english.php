...
define('TWIG_OUR_BRANDS', 'Our brands : ');
...
define('BUTTON_SEE_THIS_PRODUCT', 'See this product');
define('TWIG_PRODUCT_EXPECTED_DELAY', 'This product will be available in %s day(s)');
