  ...
  BFHLanguages.prototype = {
    ...
    , addBootstrapLanguages: function() {
      ...
      if (available.length > 0) {
        ...
        for (var i=0; i < languages.length; i++) {
          ...
          if (language.indexOf("_") != -1) {
            ...
            if (this.options.flags == true) {
              $options.append('<li role="option"><a id="'+languageArr[0]+'" class="lang" tabindex="-1" href="#" data-option="' + language + '"><i class="icon-flag-' + languageArr[1] + '"></i>' + BFHLanguagesList[languageArr[0]].toProperCase() + '</a></li>')
            } else {
              $options.append('<li role="option"><a id="'+languageArr[0]+'" class="lang" tabindex="-1" href="#" data-option="' + language + '">' + BFHLanguagesList[languageArr[0]].toProperCase() + ' (' + BFHCountriesList[languageArr[1]] + ')</a></li>')
            }
          } else {
            this.$element.append('<option value="' + language + '">' + BFHLanguagesList[language].toProperCase() + '</option>')
          }
		...
		for (var language in BFHLanguagesList) {
		  $options.append('<li role="option"><a id="'+languageArr[0]+'" class="lang" tabindex="-1" href="#" data-option="' + language + '">' + BFHLanguagesList[language].toProperCase() + '</a></li>')
		}
	  }
      ...
      $('.lang').click(function() { window.location = getQuery(window.location.href, "language", $(this).attr("id"))})
      $input.val(value)
    }
