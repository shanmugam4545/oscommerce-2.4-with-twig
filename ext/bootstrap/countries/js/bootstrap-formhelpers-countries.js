  ...
  * ====================== */
  ...
  BFHCountries.prototype = {
    ...
    , addBootstrapCountries: function() {
      ...
      if (value) {
        if (this.options.flags == true) {
          $toggle.html('<i class="icon-flag-' +this.countryList[value]['code']+ '"></i> ' + this.countryList[value]['name'])
        } else {
          $toggle.html(this.countryList[value])
        }
      }
      $('.selectcountry').click(function() { $('#countryerror').children('label').remove(); })
      $input.val(value)
    }
    ...
    , displayCountry: function () {
      ...
      if (this.options.flags == true) {
        this.$element.html('<i class="icon-flag-' + this.countryList[value]['code'] + '"></i> ' + this.countryList[value]['name'])
      } else {
