...
(function(e) {
    ...
    e.fn.prettyPhoto = function(s) {
        ...
        function k(t) {
            ...
            if (isSet && settings.overlay_gallery) {
                ...
                for (var n = 0; n < pp_images.length; n++) {
                    ...
                    toInject += "<li class='twigfoxp2'><a href='#'><img src='" + img_src + "' alt='' /></a></li>"
                }
        ...
        s = jQuery.extend({
            ...
            gallery_markup: '<div class="pp_gallery clearfix"> <a href="#" class="pp_arrow_previous">Previous</a> <div> <ul> {gallery} </ul> </div> <a href="#" class="pp_arrow_next">Next</a> </div>',
